...
function iframeRender(accessToken: any, target: HTMLElement, options: any) {
	...
	iframeDoc?.write(`
        ...
        <head>
    		...
    		<link href="https://cdn.jsdelivr.net/gh/revodigital/uni2-web-client@0.4.19/dist/style.css" rel="stylesheet" />
    		<script src='https://cdn.jsdelivr.net/gh/revodigital/uni2-web-client@0.4.19/dist/bundle.js'></script>
    		<style>
